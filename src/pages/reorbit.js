        ...
        <div className="project-page-inner">
          ...
          <div className="flex flex-col md:flex-row gap-6 md:gap-8 items-start">
            <div className="md:w-1/2 w-full min-w-0">
              <h1 className="text-3xl sm:text-4xl md:text-5xl mb-4 neon leading-tight">ReOrbit</h1>
              ...
              {/* Concept blurb */}
              <div className="mt-6 rounded-lg border border-current/10 p-3 sm:p-4 text-sm sm:text-base leading-relaxed">
