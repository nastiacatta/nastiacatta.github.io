      ...
      <div className="mb-6" data-animate>
        <div className="featured-project-card featured-project-card-hover rounded-2xl overflow-hidden">
          <div className="flex flex-col lg:flex-row">
            ...
            {/* Right: VEGA.png (transparent PNG — floats on card gradient) */}
            <div className="featured-vega-visual lg:w-1/2 border-t lg:border-t-0 lg:border-l border-pink-400/15 bg-zinc-900/25 dark:bg-pink-100/35 flex items-center justify-center overflow-hidden p-5 md:p-8 min-h-[min(260px,38vh)]">
              {!vegaImgError ? (
