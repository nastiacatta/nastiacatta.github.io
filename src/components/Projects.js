    ...
    <div>
      ...
      <div className="mb-6" data-animate>
        <div className="featured-project-card featured-project-card-hover rounded-2xl overflow-hidden">
          <div className="flex flex-col lg:flex-row">
            ...
            {/* Right: VEGA.png — transparent asset, no extra panel fill */}
            <div className="featured-vega-visual lg:w-1/2 border-t lg:border-t-0 lg:border-l border-pink-400/15 bg-transparent flex items-center justify-center overflow-hidden p-5 md:p-8 min-h-[min(240px,36vh)]">
              {!vegaImgError ? (
      ...
      <div className="mb-14" data-animate data-delay="1">
        <div className="featured-project-card rounded-2xl overflow-hidden">
          ...
          <div className="p-5 sm:p-7 md:p-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
            ...
            <div className="flex flex-row flex-wrap items-center justify-end gap-3 shrink-0">
              <button
                ...
                aria-label={mastersOpen ? 'Hide Masters details' : 'Show Masters details'}
              >
                <svg
              ...
              <a
                href="https://nastiacatta.github.io/masters/#/"
                target="_blank"
                rel="noopener noreferrer"
